...
const BenefitsSection = () => {
      ...
      {benefits.map((benefit, index) => {
        ...
        return (
          ...
          >
            ...
            <p
              className={`${textSize} ${isRightAligned ? "text-right mr-4 flex-grow" : ""}`}
              style={{ color: benefitTextColor }}
            >
              {benefit.label}
            </p>
  ...
  return (
    <section className="relative w-full overflow-hidden bg-white min-h-[500px] flex items-center justify-center py-1 px-4">
      {/* ✅ Background Image + Responsive Overlay Fix */}
      <div className="absolute inset-0 flex justify-center items-center overflow-hidden max-w-[1500px] mx-auto">
        <Image
          ...
          className="z-0"
        />
        {/* ✅ Overlay color changes with breakpoint */}
        <div className="absolute inset-0 z-10 bg-white lg:bg-black lg:opacity-30"></div>
      </div>

      {/* DESKTOP VIEW */}
      <div className="relative z-20 w-full max-w-[1200px] mx-auto hidden lg:flex flex-col items-center">
        ...
        {/* Product Image */}
        <div className="relative z-0 w-[2000px] h-[750px] mb-5 flex justify-center items-center mt-[-250px] transform -translate-x-5 -translate-y-88 flex lg:scale-210">
          <Image
            src="/rejivika-benfit-product.png"
            alt="Rejivika Product"
            layout="fill"
            objectFit="contain"
            priority
          />
      ...
      {/* TABLET VIEW */}
      <div className="relative z-20 w-full max-w-[1200px] mx-auto hidden md:flex lg:hidden flex-col items-center p-8">
        <div className="flex flex-col items-center mb-8 py-1">
          <Image
            src="/akriti-benefit-newhead.svg"
            alt="Benefits Heading Graphic"
            width={400}
            height={50}
      ...
      {/* MOBILE VIEW */}
      <div className="w-full flex justify-center py-0 relative z-20 block md:hidden">
        <div
