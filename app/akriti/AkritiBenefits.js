...
const BenefitsSection = () => {
  ...
  const benefits = [
    {
      label: "Beneficial in uneven tones and breast shapes",
      src: "/akriti-benefit_balance-fill.png",
      align: "left",
    },
    {
      label: "Enhances softness and nourishes deeply for healthy skin.",
      src: "/akriti-benefit_leaf-2-fill (1).png",
      align: "right",
    },
    {
      label: "Helpful in improving and reshaping breast curves",
      src: "/akriti-benefit_leaf-3-fill.png",
      align: "left",
    },
    {
      label: "Made with 100% Ayurvedic, safe, and trusted ingredients.",
  ...
  <Image
    ...
    style={{
      ...
      objectPosition: "center", // ✅ centers image perfectly
    }}
    className="z-0"
  />

  {/* ✅ Responsive Overlay (fixed) */}
